document.addEventListener('DOMContentLoaded',function () {
    ...
    btnRegister.addEventListener("click",function () {
        ...
        for (const rule in validationRules){
            ...
            // rules içerisinde inputları
            // name,email,password,password_confirmation u alıyoruz.
            let element = document.querySelector('[name='+ rule + ']');
            if (element){
                let elementValue = element.value.trim();

                // inputları aldık
                // inputların içerisindekileri alıyoruz
                ...
                for(const fieldKey in validationRules[rule]){
                    ...
                    if (
                        ...
                        (fieldKey === 'compareElementId' && elementValue &&
                            !checkPasswordsMatch(document.querySelector("#"+fieldValue).value,elementValue))
                    ){
